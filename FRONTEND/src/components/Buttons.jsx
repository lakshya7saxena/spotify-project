...
const Buttons = () => {
    return (
        <div className=' md:w-1/2 h-1/3 px-4 flex flex-col justify-around items-center  '>
            <h1 className='text-6xl font-serif text-center leading-22 font-extrabold drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] tracking-wide'>Welcome to Spotify</h1>
